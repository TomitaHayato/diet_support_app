...
export default function ContactForm() {
  ...
  return(
    <div className="text-sm sm:text-base px-1 pt-3">
      <h3 className="text-xl font-bold mb-5 text-center">お問い合わせ</h3>

      <div className="mb-5 text-center">
        <p className="text-center mb-2">件名</p>
      ...
      <div className="mb-5">
        <label className="input input-sm input-info input-bordered flex items-center gap-2">
          <input type="text" className="grow" placeholder="お名前" />
        </label>
      </div>

      <div className="mb-5">
        <textarea className="textarea textarea-info w-full min-h-36" placeholder="本文"></textarea>
      </div>
        ...
        <div className="w-9/12 lg:w-5/12 flex gap-2 mx-auto">
          ...
          <div className="form-control">
            <labal className="label cursor-pointer">
              ...
              <input type="radio" name="radio-res" className="radio radio-sm checked:bg-blue-500" onChange={() => hundleRadioClick(false)} />
            </labal>
          </div>
        </div>
      </div>
