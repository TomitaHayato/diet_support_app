  ...
  return(
    <>
      <div>
        ...
        <h3>禁止事項</h3>
        <p>ユーザーは、本サービスの利用にあたり、以下の行為をしてはいけません。</p>
        <ul>
        ...
        <h3>換金行為の禁止</h3>
        <p>本サービス内で取得した一歳おコンテンツまたは本仮想通貨については、手段の如何を問わず、以下の取引を一切禁止します。</p>
        <ul>
        ...
        <h3>反社会的勢力の排除</h3>
        <p>ユーザーは、次の各号のいずれか一つにも該当しないことを表明し、かつ将来にわたっても該当しないことを表明し、保証するものとします。</p>
        <ul>
        ...
        <h3>退会</h3>
        <p>ユーザーは、当社の定める手続きにより、利用登録を抹消し、本サービスから退会できるものとします。</p>
