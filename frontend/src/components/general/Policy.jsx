  ...
  return(
    <div className="text-sm sm:text-base">
      ...
      <ul className="mb-5">
        ...
        <li className="list-disc">外部サービスでお客様が利用するID、その他外部サービスのプライバシー設定によりお客様が連絡先に開示を認めた情報</li>
      ...
      <ul className="mb-5">
        ...
        <li className="list-disc">当社のサービスに関するご案内をするため</li>
        <li className="list-disc">提携する事業者・サービスのご案内をお送りするため</li>
        <li className="list-disc">お客様からのお問い合わせに対応するため</li>
        <li className="list-disc">当社の規約や法令に違反する行為に対応するため</li>
        <li className="list-disc">当社サービスの変更、提供中止、終了、契約解除をご連絡するため</li>
        <li className="list-disc">当社規約の変更等を通知するため</li>
        <li className="list-disc">以上の他、当社サービスの提供、維持、保護及び改善のため</li>
      </ul>
