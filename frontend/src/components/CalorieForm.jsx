        ...
        <div className='flex gap-4 justify-center'>
          <div className='tooltip' data-tip="摂取カロリー（整数）">
            <label className="input input-primary input-bordered flex items-center gap-2">
              ...
              <input type="number" className="grow" value={intakedCalorie} onChange={(e) => setIntakedCalorie(e.target.value)} />
            </label>
          </div>
          ...
          <div className='tooltip' data-tip="体重（整数）">
            <label className="input input-primary input-bordered flex items-center gap-2">
              ...
              <input type="number" className="grow" value={weight} onChange={(e) => setWeight(e.target.value)} />
            </label>
          </div>
